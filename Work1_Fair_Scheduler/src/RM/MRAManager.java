...
//=====================================================================================================================================================
	...
	public void create_MRAMaster()throws IOException{
		...
		wrs.write_2D(vm.VM_Matrix, "VM allocation matrix  after MRAM started (VM #, resource allocated to each VM (vCPU, memory, storage), resource wasted in each VM (vCPU, memory, storage), which flavour, VM in which PM, number of blocks stored in a VM (each block is 0.125) )");
