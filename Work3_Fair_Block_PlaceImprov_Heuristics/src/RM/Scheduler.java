...
public class Scheduler {  
	...
	public double heuristics[]={1,0,0,0,0,0,100,1,1,0,0,0,0,88,1,1,1,0,1,0,90,0,1,2,1,3,0,86,0,1,1,0,6,2,88.5}; // i found this using random combination at run time
	
	public void schedule_tasks(MRAManager mram)throws IOException{		
		this.mram=mram;	  
      	fc.get_MRAM(mram);
		//fc.max_possible();
		//heuristics=fc.suitable_combinations(); 
		String name;
		int workload_num=0;
		try{
