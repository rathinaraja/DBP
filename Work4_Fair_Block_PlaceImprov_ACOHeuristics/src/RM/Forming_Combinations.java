...
public class Forming_Combinations {
	...
	public void max_possible()throws IOException{ 
		...
		//mram.d.display_2D(max_map_possible,"possible map tasks of each workload in each VM flavor (Workload #, VM Flav 1, VM Flav 2, VM Flav 3, VM Flav 4, VM Flav 5)"); 
		write.write_2D(max_map_possible,"possible map tasks of each workload in each VM flavor (Job/Workload #, VM Flav 1, VM Flav 2, VM Flav 3, VM Flav 4, VM Flav 5)"); 
	}
